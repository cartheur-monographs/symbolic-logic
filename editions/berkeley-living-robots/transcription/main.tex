...
\caption{Figure plate from the source volume introducing ``Robot Life Species
...
\caption{Figure plate from the source volume continuing the description of the
robot world and its operating conditions.}
\end{figure}

\begin{figure}[p]
\centering
\includegraphics[width=\textwidth]{figures/page-15.png}
\caption{Figure plate from the source volume with schematic material for the
...
\caption{Figure plate from the source volume continuing the schematic material
for the robot environment and support circuits.}
\end{figure}
...
\caption{Figure plate from the source volume showing the programming sequence
for the robot species.}
\end{figure}

\begin{figure}[p]
\centering
\includegraphics[width=\textwidth]{figures/page-21.png}
\caption{Figure plate from the source volume giving the correlated programming
circuit for Robot Life Species No.\ 1.}
\end{figure}
